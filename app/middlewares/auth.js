...
//console.log('insidee', req.body);
console.log('insidee', req.header);

  if (req.params.authToken || req.query.authToken || req.body.authToken || req.header('authorization')) {
      console.log('HEADER', req.header('authorization'));
    Auth.findOne({authToken: req.header('authorization') || req.params.authToken || req.body.authToken || req.query.authToken}, (err, authDetails) => {
      if (err) {
        console.log(err)
